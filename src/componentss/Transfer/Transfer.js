...
export default function Transfer() {
  ...
  //   const response = await fetch('https://nashimiumbackend.herokuapp.com/membersearchget');
  ...
  const postDataTran = async (e) => {
    ...
    if (
      ...
      const res = await fetch(
        "https://nashimiumbackend.herokuapp.com/transferpost",
        {
          method: "POST",
          headers: {
  ...
  const postData = async (e) => {
    ...
    var memberno = rec;
    const res = await fetch(
      "https://nashimiumbackend.herokuapp.com/searchmember",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
