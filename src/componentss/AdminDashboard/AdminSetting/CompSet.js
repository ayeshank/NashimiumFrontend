...
export default function CompSet() {
    ...
    async function fetchBooks() {
      const response = await fetch('/compSetget');
    ...
    const postData=async (e)=>{
     ...
     const res=await fetch("/compSetpost",{
       method:"POST",
       headers:{
     ...
     else{ window.alert("Company Setting Updated");
    ...
    <div className="xnarates">
      ...
      <Modal show={show}>
            ...
            <Modal.Body>
              <Form >
              <Row >
                  <Col ><Form.Text className="text-muted">Company Profit Share Percentage</Form.Text></Col>
                  <Col><Form.Control size="sm" type="text" name="CompPSP" placeholder="Enter Amount" value={member.CompPSP} onChange={e=>handleInputs(e)}/></Col>
              </Row>
              <Row >
                  <Col ><Form.Text className="text-muted">Exchange Rate</Form.Text></Col>
                  <Col><Form.Control size="sm" type="text" name="ExRate" placeholder="Enter Amount" value={member.ExRate} onChange={e=>handleInputs(e)}/></Col>
              </Row>         
     </Form>
            </Modal.Body>
            <Modal.Footer>
