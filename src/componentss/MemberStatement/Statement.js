  ...
  return (
    <div className="statement" >
      ...
      <ListGroup horizontal>
        ...
        <ListGroup.Item>Name : {statement[1].name} {statement[1].surname}</ListGroup.Item>
       </ListGroup>
       </div>
      <div className="LG2">
      <ListGroup horizontal>
        <ListGroup.Item variant="success">Deposit : {(Math.floor(totdeposit*1000000000)/1000000000).toFixed(10)}</ListGroup.Item>
        <ListGroup.Item variant="danger">Withdrawn : {(Math.floor(totwithdraw*1000000000)/1000000000).toFixed(10)}</ListGroup.Item>
        <ListGroup.Item variant="info">Total : {(Math.floor(parseFloat(totdeposit)-parseFloat(totwithdraw))*1000000000/1000000000).toFixed(10)}</ListGroup.Item>
      </ListGroup> 
      </div>
      {/* <h6 className="stath6" >{t('Member Statement')}</h6>
          <div className="LG1" >
