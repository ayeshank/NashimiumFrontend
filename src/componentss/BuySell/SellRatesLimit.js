  ...
  useEffect(() => {
    const fetchAud = async () => {
      const response = await fetch(
        "https://nashimiumbackend.herokuapp.com/audlastget"
      );
      const json = await response.json();
      setData(json.al);
      const response3 = await fetch(
        "https://nashimiumbackend.herokuapp.com/statement"
      );
      const json3 = await response3.json();
      setSummary(json3.stat);
      const response4 = await fetch(
        "https://nashimiumbackend.herokuapp.com/buysellSetget"
      );
  ...
  return (
    <div className="xnarates">
      ...
      <p className="xnaratep">
        {t("Sell Order Limit Rates For Different Currencies")}
      </p>
            ...
            {arr.map((item) =>
              item === "AUD" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.AUD).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "CAD" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.CAD).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "CHF" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.CHF).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "CNY" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.CNY).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "DKK" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.DKK).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "EUR" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.EUR).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "GBP" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.GBP).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "INR" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.INR).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "JPY" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.JPY).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "KWD" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.KWD).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "MYR" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.MYR).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "NOK" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.NOK).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "PKR" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.PKR).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "QAR" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.QAR).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "RUB" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.RUB).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "SEK" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.SEK).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "SGD" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.SGD).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "TRY" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.TRY).toFixed(
                      9
                    )}
                  </td>
                  <td>
            ...
            {arr.map((item) =>
              item === "USD" ? (
                <tr>
                  ...
                  <td>
                    {(parseFloat(databs[0].MSL) * cRates[0].data.USD).toFixed(
                      9
                    )}
                  </td>
                  <td>
